...
export default function AdminCredits() {
  ...
  return (
    <AdminLayout>
      <Helmet>
        <title>Credits Verwaltung | Admin</title>
      </Helmet>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Benutzer-Wallets verwalten und Credits manuell anpassen
          </p>
        </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{stats?.totalRewardCredits?.toLocaleString() || 0}</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{stats?.totalPlayCredits?.toLocaleString() || 0}</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{stats?.totalLifetimeCredits?.toLocaleString() || 0}</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{stats?.claimableRewards || 0}</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{stats?.recentRedemptions || 0}</p>
                  <p className="text-xs text-muted-foreground">7d Einlösungen</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            <div>
              ...
              <Select value={adjustType} onValueChange={(v) => setAdjustType(v as "reward" | "play")}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="z.B. Manuelle Korrektur, Kulanz, Support-Anfrage..."
                rows={3}
              />
            </div>
          </div>
